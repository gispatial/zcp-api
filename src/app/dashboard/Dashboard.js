        ...
        <div className="proBanner">
          <div>
            <span className="d-flex align-items-center purchase-popup">
              <p className="m-0">The ZEN Charity Platform is a revolutionary tool that bridges the gap between donors and beneficiaries to make the flow of funds completely.</p>
              <a href="https://rizq.us/zcp/public/login" rel="noopener noreferrer" target="_blank" className="btn btn-sm btn-primary ml-auto">Start New Campaign!</a>
          ...
          <div className="az-content-body">
            <div className="az-dashboard-one-title">
              <div>
                ...
                <p className="az-dashboard-text">Your ZEN Charity Platform Dashboard.</p>
              </div>
            ...
            <div className="az-dashboard-nav">
              <nav className="nav">
                <a className="nav-link active" data-toggle="tab" href="https://rizq.us/zcp/public/websites/new">Overview</a>
                <a className="nav-link" data-toggle="tab" href="#/">Donors</a>
                <a className="nav-link" data-toggle="tab" href="#/">Transactions</a>
              ...
              <div className="col-lg-7 ht-lg-100p">
                <div className="card card-dashboard-one">
                  <div className="card-header">
                    <div>
                      <h6 className="card-title">Revenue by Donation Funding Campaign</h6>
                  ...
                  <div className="card-body">
                    <div className="card-body-top">
                      <div>
                        <label className="mg-b-0">Donations</label>
                        <h2>$ 379,956</h2>
                      </div>
                      <div>
                      ...
                      <div>
                        <label className="mg-b-0">Page Logs</label>
                        <h2>83,123</h2>
                      </div>
                      <div>
            ...
            <div className="row row-sm mg-b-20 mg-lg-b-0">
              ...
              <div className="col-lg-7 col-xl-8 mg-t-20 mg-lg-t-0">
                <div className="card card-table-one">
                  <h6 className="card-title">Countries that donors originated</h6>
                  ...
                  <div className="table-responsive">
                    <table className="table">
                      ...
                      <tbody>
                        <tr>
                          <td><i className="flag-icon flag-icon-cn flag-icon-squared"></i></td>
                        ...
                        <tr>
                          <td><i className="flag-icon flag-icon-hk flag-icon-squared"></i></td>
                        ...
                        <tr>
                          <td><i className="flag-icon flag-icon-jp flag-icon-squared"></i></td>
                        ...
                        <tr>
                          <td><i className="flag-icon flag-icon-my flag-icon-squared"></i></td>
